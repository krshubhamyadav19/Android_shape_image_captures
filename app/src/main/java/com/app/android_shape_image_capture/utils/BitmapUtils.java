...
public class BitmapUtils {
   ...
   /**
    * Crop the picture taken according to the range of the finder frame (light area).
    *  For a 1280x720 screen, the cropping starting point is coordinates (52, 80). After cropping, the bitmap size is 896x588. (Calculated by the layout defined by layout xml)
    * The above parameters will be converted in proportion to the actual size of the picture.
    * The device can be cropped to the correct area with or without the virtual navigation bar.
    *
    * @param originalBitmap
    * @return Bitmap after cropping
    */
