package com.app.android_shape_image_capture.view;
...
import com.app.android_shape_image_capture.R;
import com.app.android_shape_image_capture.utils.App;
import com.app.android_shape_image_capture.utils.Camera2Utils;
...
public class Camera2Activity extends AppCompatActivity {
    ...
    void setUpCameraOutputs(int width, int height) {
        ...
        try {
            for (String cameraId : manager.getCameraIdList()) {
                ...
                /**
                 * Replaced the algorithm for finding the largest size.
                 * From OutputSizes, find the maximum Size that meets the 16: 9 ratio and the number of pixels does not exceed 3840 * 2160.
                 * If not found, select the maximum Size that meets the 16: 9 ratio (the number of pixels may exceed 3840 * 2160), and if it is still not found, return the maximum Size.
                 */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity3_camera);
        mTextureView = findViewById(R.id.texture_camera_preview);
        mIvCameraButton = findViewById(R.id.iv_camera_button);
        mViewDark0 = findViewById(R.id.view_camera_dark0);
        mViewDark1 = findViewById(R.id.view_camera_dark1);
    ...
    protected void preInitData() {
        ...
        RxView.clicks(mIvCameraButton)
                /**
                 * Prevent hand-shake caused by multiple consecutive clicks
                 */
